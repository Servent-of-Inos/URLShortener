 ...
 */
final class Version20180719112440 extends AbstractMigration
{
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE statistical_record (id INT AUTO_INCREMENT NOT NULL, url_id INT NOT NULL, timestamp DATETIME NOT NULL, referrer LONGTEXT NOT NULL, ip LONGTEXT NOT NULL, browser LONGTEXT NOT NULL, INDEX IDX_68C7861B81CFDAE7 (url_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
